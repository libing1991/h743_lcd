...
//变量定义
#define LTDC_LCD_FRAMEBUF_SIZE		(LV_HOR_RES_MAX*LV_VER_RES_MAX*2)		//ltdc.c中ltdc_lcd_framebuf缓冲区的大小
...
extern void LCD_Color_Fill(INT16U sx, INT16U sy, INT16U ex, INT16U ey, INT16U *color);
...
{
	//把指定区域的显示缓冲区内容写入到屏幕
	LCD_Color_Fill(area->x1,area->y1,area->x2,area->y2,(INT16U *)color_p);
