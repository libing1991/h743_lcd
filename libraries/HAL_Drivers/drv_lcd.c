...
uint8_t ltdc_lcd_framebuf[LCD_BUF_SIZE] __attribute__((at(0XC0000000)));
uint8_t ltdc_lcd_framebuf1[LCD_BUF_SIZE] __attribute__((at(0XC0000000 + LCD_BUF_SIZE)));
uint8_t ltdc_lcd_framebuf2[LCD_BUF_SIZE] __attribute__((at(0XC0000000 + LCD_BUF_SIZE + LCD_BUF_SIZE)));
int drv_lcd_hw_init(void)
{
    ...
    _lcd.front_buf = ltdc_lcd_framebuf2;//rt_malloc(LCD_BUF_SIZE);
...
int lcd_test()
{
    ...
    while (1)
    {
        ...
        {
            lcd->lcd_info.framebuffer[2 * i] = rgbData ++;
